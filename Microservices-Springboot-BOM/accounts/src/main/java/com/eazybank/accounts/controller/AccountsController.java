...
public class AccountsController {
    ...
    //if only one constructor then no need @Autowired annotation , spring will inject dependencies automatically
    public AccountsController(IAccountsService iAccountsService,Environment environment,AccountsContactsInfoDto accountsContactsInfoDto){
    ...
    @Operation(
            summary = "Build Information Details REST API",
            description = "REST API to provide build information for accounts microservice"
    )
    @ApiResponses(
            {
                    @ApiResponse(
    ...
    @Operation(
            ...
            description = "REST API to provide Java version and maven version information for accounts microservice"
    )
    @ApiResponses(
            {
                    @ApiResponse(
    ...
    @Operation(
            ...
            description = "REST API to provide JContact Information for accounts microservice"
    )
    @ApiResponses(
            {
                    @ApiResponse(

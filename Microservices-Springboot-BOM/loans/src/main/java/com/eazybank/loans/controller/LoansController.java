...
import com.eazybank.loans.dto.LoansContactsInfoDto;
...
public class LoansController {
    ...
    public LoansController(ILoansService iLoansService,Environment environment,LoansContactsInfoDto loansContactsInfoDto){
        ...
        this.loansContactsInfoDto=loansContactsInfoDto;
    }
...
//        logger.debug("eazyBank-correlation-id found: {} ", correlationId);
    ...
    @Operation(
            ...
            description = "Provide version details of Loans microservice"
    )
    @ApiResponses(
            {
                    @ApiResponse(
    ...
    @Operation(
            ...
            description = "REST API to provide Java version and maven version information for loans microservice"
    )
    @ApiResponses(
            {
                    @ApiResponse(
    ...
    @Operation(
            ...
            description = "REST API to provide Contact Information for Loans microservice"
    )
    @ApiResponses(
            {
                    @ApiResponse(
